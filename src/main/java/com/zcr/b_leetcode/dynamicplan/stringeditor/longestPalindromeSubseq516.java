...
public class longestPalindromeSubseq516 {
     ...
     *
     * 一般来说，这类问题都是让你求一个最长子序列，因为最短子序列就是一个字符嘛，没啥可问的。一旦涉及到子序列和最值，
     * 那几乎可以肯定，考察的是动态规划技巧，时间复杂度一般都是 O(n^2)。
     *
     ...
     *     }
     * }
     * 这种思路运用相对更多一些，尤其是涉及两个字符串/数组的子序列，比如前文讲的「最长公共子序列」。
     ...
     * 斜着遍历
     * 倒着遍历
     * 返回结果dp[0][n-1]dp[0][n−1]其实就是s[0...n-1]s[0...n−1]的最长回文子序列的长度
     *
     * @param s
     * @return
     */
